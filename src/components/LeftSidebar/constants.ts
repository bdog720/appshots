...
export const STYLES = {
  /** Sidebar container */
  sidebar: "w-72 shrink-0 border-r border-white/10 bg-panel flex flex-col",
  ...
  selectionButtonInactive: "bg-input text-zinc-300 hover:bg-raised",
  ...
  primaryButton:
    "w-full mt-3 bg-white hover:bg-zinc-200 text-black font-medium py-2.5 rounded-lg transition-colors",
} as const;
